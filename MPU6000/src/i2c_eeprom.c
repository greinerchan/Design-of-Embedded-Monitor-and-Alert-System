...
uint8_t i2c_write(uint8_t dev_address, uint32_t address, uint32_t size, uint8_t *wr_data_ptr)
{
	uint32_t bytes_written; 
	uint32_t feasible_size = size;
    uint32_t bytes_left_to_send;  
...
uint32_t i2c_read(uint8_t dev_address,uint32_t address,  uint32_t size,uint8_t *rd_data_ptr)
{
    uint32_t tmp_size;
    uint32_t bytes_read; 
